...
(defrule initialize-techniques
  ...
  (declare (salience 10))
   ...
   (assert (technique (name Check-Diagonal) (rank 19))))
...
(defrule naked-single-diagonal
   ...
   (possible (value ?v) (diagonal ?p&:(< 0 ?p)) (id ?id))
   
   (not (possible (value ~?v) (diagonal ?p&:(< 0 ?p)) (id ?id)))
   
   (possible (value ?v) (diagonal ?p&:(< 0 ?p)) (id ?id2&~?id))
...
(defrule hidden-single-diagonal
   ...
   (possible (value ?v2&~?v)  (diagonal ?p&:(< 0 ?p)) (id ?id))
...
(defrule diagonal
   ...
   (possible (value ?v) (row ?r) (diagonal ?p&:(< 0 ?p) ) )
   
   (not (possible (value ?v) (row ~?r) (diagonal ?p&:(< 0 ?p))))
   
   (possible (value ?v) (row ?r) (diagonal ?p&:(< 0 ?p)) (id ?id))
